...
#take a look at the queue without altering it  
  def peek(self):
    if self.size > 0:
...
#Check if the queue has space. Prevents overflow  
  def has_space(self):
...
#Check if the queue is empty. Prevents underflow   
  def is_empty(self):
    return self.size == 0



#Testing of the code functionallity
